...
export default function AdminDashboard() {
  ...
  const stats = [
    { label: "Total Creators", value: "1.2M", icon: Users, color: "bg-blue-500", trend: "+12%" },
    { label: "Total Videos", value: "85.4M", icon: Video, color: "bg-[#FE2C55]", trend: "+8%" },
    { label: "Active Reports", value: "2.4K", icon: ShieldAlert, color: "bg-orange-500", trend: "-5%" },
    { label: "Daily Active Users", value: "450K", icon: TrendingUp, color: "bg-green-500", trend: "+15%" },
  ];
    ...
    <div className="flex h-screen bg-[#F8FAFC]">
      ...
      <div className="w-64 bg-black text-white flex flex-col shadow-2xl">
        <div className="p-6 flex items-center gap-3">
          <div className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center relative overflow-hidden group">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8">
          <div className="relative w-96">
            ...
            <input 
              type="text" 
              placeholder="Search creators, videos, or reports..." 
          ...
          <div className="flex items-center gap-6">
            <button className="relative p-2 text-gray-500 hover:bg-gray-100 rounded-full transition-all">
              ...
              <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-[#FE2C55] rounded-full border-2 border-white"></span>
            </button>
          ...
          <div className="max-w-7xl mx-auto space-y-8">
            <div className="flex items-end justify-between">
              <div>
                ...
                <p className="text-gray-500">Welcome back! Here's what's happening on TopTop today.</p>
              </div>
              <div className="flex gap-3">
                <button className="px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm font-semibold hover:bg-gray-50 transition-all">Download Report</button>
                <button className="px-4 py-2 bg-black text-white rounded-lg text-sm font-semibold hover:bg-gray-900 transition-all">Live Monitor</button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="p-6 border-b border-gray-100 flex justify-between items-center">
                  <h3 className="font-bold text-gray-900">Recent Critical Reports</h3>
                  <button className="text-sm text-[#FE2C55] font-bold hover:underline">View all</button>
                </div>
                <div className="overflow-x-auto">
                  <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      <TableRow user="@creative_mind" type="Inappropriate Content" status="Pending" />
                      <TableRow user="@dance_king_99" type="Copyright Claim" status="In Review" />
                      <TableRow user="@tech_guru" type="Spam Activity" status="Resolved" />
                      <TableRow user="@morning_vibes" type="Harassment" status="High Priority" />
                    </tbody>
                  </table>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <div className="space-y-6">
                  <HealthBar label="CDN Performance" value={98} color="bg-green-500" />
                  <HealthBar label="API Response Time" value={92} color="bg-[#FE2C55]" />
                  <HealthBar label="Moderation Queue" value={45} color="bg-orange-500" />
                  <HealthBar label="Storage Capacity" value={78} color="bg-blue-500" />
                </div>
                <div className="mt-8 p-4 bg-gray-50 rounded-xl">
                  <p className="text-xs text-gray-500 leading-relaxed">
                    Systems are currently operating within normal parameters. Last backup: 14 mins ago.
                  </p>
                </div>
              </div>
            </div>
